...
// (la página, las fuentes de Google Fonts, etc.), que es todo lo que este POS necesita
// porque es un solo archivo autocontenido (sin imágenes ni JS/CSS externos propios).
//
